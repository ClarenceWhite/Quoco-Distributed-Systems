...
public class Main {
    public static void main(String[] args){
        ...
        ActorRef ref = system.actorOf(Props.create(Quoter.class), "auldfellas"); //create an actor ref
        ref.tell(new Init(new AFQService()), null); //send a message asynchronously to initialize a service object
