                ...
                try {
                    ...
                    if (ddq_quotation_request_message instanceof ObjectMessage) {
                        ...
                        if (ddq_quotation_request_message_content instanceof QuotationRequestMessage) {
                            ...
                            QuotationRequestMessage ddq_quotation_request = (QuotationRequestMessage) ddq_quotation_request_message_content;

                            // Generate a quotation and send a quotation response message
                            Quotation ddq_final_quotation = ddq_service_instance.generateQuotation(ddq_quotation_request.info);
                            Message ddq_final_quotation_response = session.createObjectMessage(new QuotationResponseMessage(ddq_quotation_request.id, ddq_final_quotation));
